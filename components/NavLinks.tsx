...
export const navLinks = [
  { name: "Finn bane", description: "Søk etter tilgjengelige baner i nærheten.", href: "/baner", icon: MagnifyingGlassCircleIcon },
  { name: "Mest populære", description: "De mest populære banene.", href: "/baner", icon: StarIcon },
