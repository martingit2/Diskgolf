...
const sampleFAQs = [
  {
    id: '1',
    question: 'Hva er frisbeegolf?',
    answer: 'Frisbeegolf er et spill som ligner på tradisjonell golf, men i stedet for å bruke køller og en ball, kaster spillerne en frisbee mot et målkurv. Målet er å fullføre hver bane med færrest mulig kast.'
  },
  {
    id: '2',
    question: 'Hvordan kommer jeg i gang med frisbeegolf?',
    answer: 'For å komme i gang trenger du en frisbee, som kan kjøpes i en lokal frisbeegolfbutikk eller på nett. Mange parker har frisbeegolfbaner, så finn en i nærheten og prøv det. Det er en flott utendørsaktivitet for alle ferdighetsnivåer.'
  },
  {
    id: '3',
    question: 'Hva slags utstyr trenger jeg for frisbeegolf?',
    answer: 'Som et minimum trenger du en frisbee. De fleste spillere starter med en driver, en midrange og en putter. Du kan også ha behov for en bag til å bære diskene dine og et håndkle for å tørke dem.'
  },
  {
    id: '4',
    question: 'Hva er de grunnleggende reglene for frisbeegolf?',
    answer: 'De grunnleggende reglene ligner på tradisjonell golf. Spillerne starter fra utslagsfeltet, kaster en frisbee mot kurven og prøver å fullføre banen med færrest mulig kast. Banen består av flere hull, vanligvis 18.'
  },
  {
    id: '5',
    question: 'Er frisbeegolf en god sport for nybegynnere?',
    answer: 'Ja! Frisbeegolf er nybegynnervennlig og kan nytes av folk på alle ferdighetsnivåer. Start med noen få grunnleggende disker og øv på en lokal bane.'
  },
  {
    id: '6',
    question: 'Hvor lang tid tar en runde frisbeegolf?',
    answer: 'En runde frisbeegolf tar vanligvis mellom 1,5 og 3 timer, avhengig av banens vanskelighetsgrad, antall spillere og deres ferdighetsnivåer.'
  },
  {
    id: '7',
    question: 'Hva er en frisbeegolfbane?',
    answer: 'En frisbeegolfbane er en utendørs bane som består av en serie med "hull" (vanligvis 9 eller 18). Hvert hull har et utslagsfelt, en målkurv og ulike hindringer som trær, vann og bakker.'
  },
  {
    id: '8',
    question: 'Hvilke typer disker brukes i frisbeegolf?',
    answer: 'Det finnes tre hovedtyper disker i frisbeegolf: drivere (for lange kast), midrange-disker (for mer kontrollerte kast) og puttere (for korte, presise kast nær kurven).'
  },
  {
    id: '9',
    question: 'Kan jeg spille frisbeegolf på hvilken som helst golfbane?',
  ...
  {
    id: '10',
    question: 'Hva er fordelene med å spille frisbeegolf?',
  ...
  {
    id: '11',
    question: 'Hvordan holder jeg diskene mine i god stand?',
  ...
  {
    id: '12',
    question: 'Hvordan vet jeg hvilken disk jeg skal kaste?',
  ...
  {
    id: '13',
    question: 'Kan jeg spille frisbeegolf i regnet?',
  ...
  {
    id: '14',
    question: 'Hva er par i frisbeegolf?',
  ...
  {
    id: '15',
    question: 'Hva er de ulike kasteteknikkene i frisbeegolf?',
...
const FAQPage = () => {
  ...
  const itemsPerPage = 7;  // Set to 3 items per page

  // Calculate the total number of pages based on filtered FAQ data
  useEffect(() => {
  ...
  // Get the FAQ content for the current page
      ...
      <ul className="mt-6 space-y-6">
        {getPaginatedFAQs().length > 0 ? (
          getPaginatedFAQs().map((faq) => (
            <li key={faq.id} className="p-6 bg-gray-100 border border-gray-300 rounded-lg shadow-sm">
