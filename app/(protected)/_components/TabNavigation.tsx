    ...
    <div className="flex flex-col items-center">
      <div className="flex justify-center space-x-6 mt-4">
        ...
        <button
          ...
          className={`py-2 px-4 text-sm font-semibold ${selectedTab === "minKlubb" ? "text-green-700" : "text-gray-900 hover:text-blue-950"}`}
        >
          Min Klubb
        </button>
        ...
        <button
          ...
          className={`py-2 px-4 text-sm font-semibold ${selectedTab === "klubbInnstillinger" ? "text-green-700" : "text-gray-900 hover:text-blue-950"}`}
        >
          Klubbinnstillinger
        </button>
        <span className="text-gray-400">|</span>
        ...
        <button
          ...
          className={`py-2 px-4 text-sm font-semibold ${selectedTab === "klubbMedlemmer" ? "text-green-700" : "text-gray-900 hover:text-blue-950"}`}
        >
          Klubbmedlemmer
        </button>
        <span className="text-gray-400">|</span>
        ...
        {userRole === "ADMIN" || userRole === "CLUB_LEADER" ? (
          <>
            <button
              ...
              className={`py-2 px-4 text-sm font-semibold ${selectedTab === "redigerKlubb" ? "text-green-700" : "text-gray-900 hover:text-blue-950"}`}
            >
        ...
        <button
          ...
          className={`py-2 px-4 text-sm font-semibold ${selectedTab === "opprettKlubb" ? "text-green-700" : "text-gray-900 hover:text-blue-950"}`}
        >
          Opprett Klubb
        </button>
      </div>
      ...
      {selectedTab === "redigerKlubb" && (userRole === "ADMIN" || userRole === "CLUB_LEADER") ? (
        clubId ? (
          ...
          <p className="text-gray-900">Vennligst velg en klubb før du kan legge til nyheter.</p>  // Hvis ingen klubb er valgt
        )
      ) : null}
    </div>
  );
